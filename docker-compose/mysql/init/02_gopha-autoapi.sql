...
INSERT INTO `sys_autoapi_handle` VALUES ('1924633452166762497', 'admin', '2025-05-20 09:09:08', 'admin', '2025-06-26 08:59:26', 'A01', 'JSON转XML', 'JSON转XML', 'package org.jeecg\n\n\nimport com.alibaba.fastjson.JSON\nimport com.alibaba.fastjson.JSONObject\nimport org.jeecg.modules.autoapi.service.AfterExecuteHandleService\n\nimport javax.servlet.http.HttpServletRequest\nimport javax.servlet.http.HttpServletResponse\n\nclass CommonHandleScript implements  AfterExecuteHandleService{\n\n\n	@Override\n	public Object doPress(HttpServletRequest request, HttpServletResponse response,Object result) {\n		try {\n			StringBuffer buffer = new StringBuffer();\n			buffer.append(\"<?xml version=\\\"1.0\\\" encoding=\\\"utf-8\\\"?>\");\n			Map map=new HashMap();\n			map.put(\"item\",result);\n			String resultJson = JSON.toJSONString(map);\n			// 使用简单的XML转换方式，避免依赖org.json.XML\n			String xml = \"<xml><item>\" + escapeXml(resultJson) + \"</item></xml>\";\n			buffer.append(xml);\n			return buffer.toString();\n		}catch(Exception e){\n			return \"\";\n		}\n	}\n\n	// 简单的XML转义方法\n	private String escapeXml(String input) {\n		if (input == null) return \"\";\n		return input.replace(\"&\", \"&amp;\")\n					.replace(\"<\", \"&lt;\")\n					.replace(\">\", \"&gt;\")\n					.replace(\"\\\"\", \"&quot;\")\n					.replace(\"\'\", \"&apos;\");\n	}\n}');
